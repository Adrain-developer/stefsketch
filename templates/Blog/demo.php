...
@media only screen and (min-width:1000px) {
    ...
    #header-outer .column-margin-4pct.wpb_row>.span_12,
    ...
    #header-outer .column-margin-4pct .wpb_column:not(.child_column),
    #header-outer .column-margin-4pct.inner_row>div>.child_column,
    #ajax-content-wrap .column-margin-4pct .wpb_column:not(.child_column),
    #ajax-content-wrap .column-margin-4pct.inner_row>div>.child_column {
...
@media only screen,
print {
    .nectar-meta-category-el.alignment_left_desktop {
...
print {
    ...
    body #ajax-content-wrap .font_size_desktop_3vw.font_size_max_54px.nectar-responsive-text,
    body .font_size_desktop_3vw.font_size_max_54px.nectar-responsive-text {
...
print {
    ...
    body #ajax-content-wrap .font_size_desktop_3vw.font_size_max_54px.nectar-responsive-text,
    body .font_size_desktop_3vw.font_size_max_54px.nectar-responsive-text,
    body #header-outer .font_size_desktop_3vw.font_size_max_54px.nectar-responsive-text {
        font-size: min(54px, 3vw);
    }
}
...
@media only screen and (max-width:999px) {
    ...
    body #ajax-content-wrap .font_size_tablet_5vw.font_size_max_54px.nectar-responsive-text,
    body .font_size_tablet_5vw.font_size_max_54px.nectar-responsive-text {
...
@media only screen and (max-width:999px) {
    ...
    body #ajax-content-wrap .container-wrap .font_size_tablet_5vw.font_size_max_54px.nectar-responsive-text,
    body .container-wrap .font_size_tablet_5vw.font_size_max_54px.nectar-responsive-text,
    body #header-outer .font_size_tablet_5vw.font_size_max_54px.nectar-responsive-text {
        font-size: min(54px, 5vw);
    }
}
...
@media only screen and (max-width:690px) {
    ...
    html body #ajax-content-wrap .font_size_phone_34px.font_size_max_54px.nectar-responsive-text,
    html body .font_size_phone_34px.font_size_max_54px.nectar-responsive-text {
...
@media only screen and (max-width:690px) {
    ...
    html body #ajax-content-wrap .container-wrap .font_size_phone_34px.font_size_max_54px.nectar-responsive-text,
    html body .container-wrap .font_size_phone_34px.font_size_max_54px.nectar-responsive-text,
    html body #header-outer .font_size_phone_34px.font_size_max_54px.nectar-responsive-text {
        font-size: min(54px, 34px);
    }
}
...
@media only screen and (max-width:999px) {
    .nectar-meta-category-el.alignment_default_tablet {
        justify-content: flex-start;
    }
}
...
@media only screen and (max-width:999px) {
    ...
    #ajax-content-wrap .column-margin-4pct.inner_row>div>.child_column[class*="vc_col-xs"]:not(.vc_col-xs-12) {
        padding-left: calc(4%/2);
        padding-right: calc(4%/2);
    }
}
...
@media only screen and (max-width:999px) and (min-width:691px) {
    #ajax-content-wrap .column-margin-4pct.wpb_row>.span_12:has(> [data-t-w-inherits="small_desktop"]) {
        margin-left: calc(4%/-2);
        margin-right: calc(4%/-2);
    }

    #ajax-content-wrap .column-margin-4pct.wpb_row>.span_12:has(> [data-t-w-inherits="small_desktop"])>.wpb_column {
        padding-left: calc(4%/2);
        padding-right: calc(4%/2);
    }
}
...
@media only screen and (max-width:690px) {
    .nectar-meta-category-el.alignment_default_phone {
        justify-content: flex-start;
    }
}
        ...
        <div class="row  ">
            <div class="post-area col span_12">
                <div id="portfolio-extra">
                    <div id="fws_68d461f0f07aa" data-column-margin="custom" data-midnight="light"
                                ...
                                <div class="n-sticky">
                                    <div class="vc_column-inner">
                                        <div class="wpb_wrapper">
                                            <div
                                                class="nectar-responsive-text font_size_max_54px font_size_desktop_3vw font_size_tablet_5vw font_size_phone_34px font_line_height_1-1 nectar-link-underline-effect">
                                                <h3>Frost &amp; Feather</h3>
                                            </div>
                                            <div id="fws_68d461f0f0bc8" data-midnight="" data-column-margin="default"
                                                ...
                                                <div class="row_col_wrap_12_inner col span_12  left">
                                                    <div class="vc_col-sm-6 vc_col-xs-6 wpb_column column_container vc_column_container col child_column no-extra-padding el_spacing_5px inherit_tablet inherit_phone "
                                                        ...
                                                        <div class="vc_column-inner">
                                                            <div class="wpb_wrapper">
                                                                <div
                                                                    class="nectar-responsive-text font_line_height_1-2 nectar-link-underline-effect">
                                                                    <h5>What we did</h5>
                                                                </div><span
                                                                    class="nectar-meta-category-el  alignment_left_desktop alignment_default_tablet alignment_default_phone  style-default"><span>Web
                                                                        Design</span></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div id="fws_68d461f0f11cf" data-midnight="" data-column-margin="default"
                                                class="wpb_row vc_row-fluid vc_row inner_row" style="">
                                                <div class="row-bg-wrap">
                                                    <div class="row-bg"></div>
                                                </div>
                                                    ...
                                                    <div class="vc_col-sm-12 wpb_column column_container vc_column_container col child_column no-extra-padding el_spacing_10px inherit_tablet inherit_phone "
                                                        ...
                                                        <div class="vc_column-inner">
                                                            <div class="wpb_wrapper">
                                                                ...
                                                                <div
                                                                    class="nectar-responsive-text nectar-link-underline-effect">
                                                                    <p>Frost &amp; Feather is a visionary architecture
                                                                        firm. I was tasked to
                                                                        design a sleek and modern website that reflects
                                                                        their innovative approach
                                                                        to space and design. The site’s clean aesthetics
                                                                        and intuitive layout
                                                                        highlight their impressive portfolio, creating a
                                                                        seamless user experience
                                                                        that mirrors the sophistication of their
                                ...
                                <div class="vc_column-inner">
                                    <div class="wpb_wrapper">
                                        <div class="img-with-aniamtion-wrap " data-max-width="100%"
                                            data-max-width-mobile="default" data-border-radius="20px" data-shadow="none"
                                            data-animation="none">
                                            <div class="inner">
                                                <div class="hover-wrap">
                                                    <div class="hover-wrap-inner">
                                                        <img fetchpriority="high" decoding="async"
                                                            ...
                                                            height="2112" width="2048" data-animation="none"
                                                            src="/webroot/img/stefsketch-1.jpg" alt=""
                                                            srcset="/webroot/img/stefsketch-1.jpg 2048w, /webroot/img/stefsketch-1.jpg 291w, /webroot/img/stefsketch-1.jpg 993w, /webroot/img/stefsketch-1.jpg 768w, /webroot/img/stefsketch-1.jpg 1489w, /webroot/img/stefsketch-1.jpg 1986w"
                                                ...
                                                <div class="hover-wrap">
                                                    <div class="hover-wrap-inner">
                                                        <img decoding="async"
                                                            ...
                                                            data-delay="0" height="1706" width="2560"
                                                            data-animation="none"
                                                            data-nectar-img-src="/webroot/img/stefsketch-1.jpg"
                                                            src="/webroot/img/stefsketch-1.jpg" alt=""
                                                            data-nectar-img-srcset="/webroot/img/stefsketch-1.jpg 2560w, /webroot/img/stefsketch-1.jpg 300w, /webroot/img/stefsketch-1.jpg 1024w, /webroot/img/stefsketch-1.jpg 768w, /webroot/img/stefsketch-1.jpg 1536w, /webroot/img/stefsketch-1.jpg 2048w"
                                ...
                                <div class="wpb_wrapper">
                                    ...
                                    <div class='nectar-post-grid-wrap text-color-light spacing-10px'
                                        ...
                                        <div class="nectar-post-grid custom_font_size_3vw font_size_max_54px font_size_tablet_5vw font_size_phone_34px text-opacity-1 text-opacity-hover-1 overlaid-aspect-ratio-image-size-1-1 category-position-before-title category-button-color-rgba__10_10_10_0--2__ "
                                            ...
                                            <div class="nectar-post-grid-item" data-post-id="63" data-has-img="true">
                                                <div class="inner">
                                                        ...
                                                        <div class="nectar-el-parallax-scroll"
                                                            ...
                                                            <div class="nectar-post-grid-item-bg-wrap-inner">
                                                                <div class="nectar-post-grid-item-bg"><img
                                                                        ...
                                                                        src="data:image/svg+xml;charset=utf-8,%3Csvg%20xmlns%3D'http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg'%20viewBox%3D'0%200%202560%202560'%2F%3E"
                                                                        alt="" height="2560" width="2560"
                                                                        data-nectar-img-src="https://--.com/salient/portfolio-quantum/wp-content/uploads/sites/43/2024/09/serhii-tyaglovsky-Ay_HG60pHHw-unsplash-1024x1024.webp"
                                                                        data-nectar-img-srcset="https://--.com/salient/portfolio-quantum/wp-content/uploads/sites/43/2024/09/serhii-tyaglovsky-Ay_HG60pHHw-unsplash-1024x1024.webp 1024w, https://--.com/salient/portfolio-quantum/wp-content/uploads/sites/43/2024/09/serhii-tyaglovsky-Ay_HG60pHHw-unsplash-300x300.webp 300w, https://--.com/salient/portfolio-quantum/wp-content/uploads/sites/43/2024/09/serhii-tyaglovsky-Ay_HG60pHHw-unsplash-150x150.webp 150w, https://--.com/salient/portfolio-quantum/wp-content/uploads/sites/43/2024/09/serhii-tyaglovsky-Ay_HG60pHHw-unsplash-768x768.webp 768w, https://--.com/salient/portfolio-quantum/wp-content/uploads/sites/43/2024/09/serhii-tyaglovsky-Ay_HG60pHHw-unsplash-1536x1536.webp 1536w, https://--.com/salient/portfolio-quantum/wp-content/uploads/sites/43/2024/09/serhii-tyaglovsky-Ay_HG60pHHw-unsplash-2048x2048.webp 2048w, https://--.com/salient/portfolio-quantum/wp-content/uploads/sites/43/2024/09/serhii-tyaglovsky-Ay_HG60pHHw-unsplash-140x140.webp 140w, https://--.com/salient/portfolio-quantum/wp-content/uploads/sites/43/2024/09/serhii-tyaglovsky-Ay_HG60pHHw-unsplash-100x100.webp 100w, https://--.com/salient/portfolio-quantum/wp-content/uploads/sites/43/2024/09/serhii-tyaglovsky-Ay_HG60pHHw-unsplash-350x350.webp 350w, https://--.com/salient/portfolio-quantum/wp-content/uploads/sites/43/2024/09/serhii-tyaglovsky-Ay_HG60pHHw-unsplash-800x800.webp 800w"
                                                                        sizes="(max-width: 1024px) 100vw, 1024px" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="bg-overlay" style=" background-color: #000000;"
                                                        data-opacity="0.1" data-hover-opacity="0.2"></div>
                                                    <div class="content"><span
                                                            class="nectar-post-grid__arrow-indicator"><svg
                                                                stroke="currentColor" fill="currentColor"
                                                                stroke-width="0" viewBox="60 58 140 140" height="200px"
                                                            ...
                                                            href="../neon-grove/index.html"><span
                                            ...
                                            <div class="nectar-post-grid-item" data-post-id="23" data-has-img="true">
                                                <div class="inner">
                                                    <div class="nectar-post-grid-item-bg-wrap">
                                                        <div class="nectar-el-parallax-scroll"
                                                            data-scroll-animation="true"
                                                            ...
                                                            <div class="nectar-post-grid-item-bg-wrap-inner">
                                                                <div class="nectar-post-grid-item-bg"><img
                                                                        ...
                                                                        src="data:image/svg+xml;charset=utf-8,%3Csvg%20xmlns%3D'http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg'%20viewBox%3D'0%200%202560%202560'%2F%3E"
                                                                        alt="" height="2560" width="2560"
                                                                        data-nectar-img-src="https://--.com/salient/portfolio-quantum/wp-content/uploads/sites/43/2024/09/google-deepmind-pLh_n9pnRhw-unsplash-1024x1024.webp"
                                                                        data-nectar-img-srcset="https://--.com/salient/portfolio-quantum/wp-content/uploads/sites/43/2024/09/google-deepmind-pLh_n9pnRhw-unsplash-1024x1024.webp 1024w, https://--.com/salient/portfolio-quantum/wp-content/uploads/sites/43/2024/09/google-deepmind-pLh_n9pnRhw-unsplash-300x300.webp 300w, https://--.com/salient/portfolio-quantum/wp-content/uploads/sites/43/2024/09/google-deepmind-pLh_n9pnRhw-unsplash-150x150.webp 150w, https://--.com/salient/portfolio-quantum/wp-content/uploads/sites/43/2024/09/google-deepmind-pLh_n9pnRhw-unsplash-768x768.webp 768w, https://--.com/salient/portfolio-quantum/wp-content/uploads/sites/43/2024/09/google-deepmind-pLh_n9pnRhw-unsplash-1536x1536.webp 1536w, https://--.com/salient/portfolio-quantum/wp-content/uploads/sites/43/2024/09/google-deepmind-pLh_n9pnRhw-unsplash-2048x2048.webp 2048w, https://--.com/salient/portfolio-quantum/wp-content/uploads/sites/43/2024/09/google-deepmind-pLh_n9pnRhw-unsplash-140x140.webp 140w, https://--.com/salient/portfolio-quantum/wp-content/uploads/sites/43/2024/09/google-deepmind-pLh_n9pnRhw-unsplash-100x100.webp 100w, https://--.com/salient/portfolio-quantum/wp-content/uploads/sites/43/2024/09/google-deepmind-pLh_n9pnRhw-unsplash-350x350.webp 350w, https://--.com/salient/portfolio-quantum/wp-content/uploads/sites/43/2024/09/google-deepmind-pLh_n9pnRhw-unsplash-800x800.webp 800w"
                                                                        sizes="(max-width: 1024px) 100vw, 1024px" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="content"><span
                                                            ...
                                                            href="../aurora/index.html"><span
                                                                class="screen-reader-text">Aurora</span></a><span
                                                            class="meta-category"><a class="photography style-button"
                ...
                <div id="portfolio-nav">
                    ...
                    <ul class="controls">
                        <li class="previous-project ">
                            <div class="proj-bg-img" style="background-image: url(/webroot/img/stefsketch-1.jpg);">
                            </div><a href=""></a>
                            <h3><span>Previous Project</span><span class="text">Salient Concert Promo
                        ...
                        <li class="next-project ">
                            ...
                            <h3><span>Next Project</span><span class="text">Claire Smith
                                    <svg class="next-arrow" xmlns="http://www.w3.org/2000/svg"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 39 12">
                                        <line class="top" x1="23" y1="-0.5" x2="29.5" y2="6.5" stroke="#ffffff;"></line>
                                        <line class="bottom" x1="23" y1="12.5" x2="29.5" y2="5.5" stroke="#ffffff;">
