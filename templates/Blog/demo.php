                        ...
                        <div class="vc_column-inner">
                          <div class="wpb_wrapper">
                              ...
                              <div class="row_col_wrap_12_inner col span_12  left">
                                <div
                                  ...
                                  <div class="vc_column-inner">
                                    <div class="wpb_wrapper">
                                      <div
                                        class="nectar-scrolling-text font_size_7vw font_size_mobile_10vw text_space_medium "
                                        data-style="default" data-s-dir="ltr" data-spacing="true"
                                        data-outline-thickness="thin" data-s-speed="slow" data-overflow="hidden">
                            ...
                            <div class='nectar-post-grid-wrap text-color-light spacing-10px'
                              ...
                              <div
                                class="nectar-post-grid custom_font_size_3vw font_size_max_54px font_size_tablet_5vw font_size_phone_34px text-opacity-1 text-opacity-hover-1 overlaid-aspect-ratio-image-size-1-1 category-position-before-title category-button-color-rgba__10_10_10_0--2__ "
                                data-indicator="" data-indicator-style="default" data-indicator-text-color="#fff"
                                data-indicator-color="#000" data-indicator-text="View" data-columns="2"
                                  ...
                                  <div class="inner">
                                    <div class="nectar-post-grid-item-bg-wrap">
                                      <div class="nectar-el-parallax-scroll" data-scroll-animation="true"
                                        data-scroll-animation-mobile="true" data-scroll-animation-intensity="-0.75"
                                    ...
                                    <div class="bg-overlay" style=" background-color: #000000;" data-opacity="0.1"
                                      data-hover-opacity="0.2"></div>
                                    <div class="content"><span class="nectar-post-grid__arrow-indicator"><svg
                                        ...
                                        href="../neon-grove/index.html"><span class="screen-reader-text">Neon
                                          Grove</span></a><span class="meta-category"><a class="branding style-button"
                                ...
                                <div class="nectar-post-grid-item" data-post-id="23" data-has-img="true">
                                  <div class="inner">
                                    ...
                                    <div class="content"><span class="nectar-post-grid__arrow-indicator"><svg
                                        ...
                                        </svg></span><a class="nectar-post-grid-link" href="../aurora/index.html"><span
                                          class="screen-reader-text">Aurora</span></a><span class="meta-category"><a
						...
						<div id="portfolio-nav">
							...
							<ul class="controls">
								<li class="previous-project ">
									<div class="proj-bg-img"
										style="background-image: url(/webroot/img/stefsketch-1.jpg);">
									</div><a
										href=""></a>
